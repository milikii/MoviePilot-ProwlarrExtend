...
当前 ProwlarrExtend 为 v2.8：配置页支持桥接索引器多选（空=全部），catalog 持久化供表单选项，连接/状态 API 回报过滤后数量；v2.7 修正详情页表头与列、headers 复用与契约/CI。完整历史见 [`package.v2.json`](./package.v2.json)。
